            ...
            <div class="col-sm-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table  id="basvurularim" class="row-border hover order-column" cellspacing="0" width="100%">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table  id="kazandigimBasvuru" class="row-border hover order-column" cellspacing="0" width="100%">
                            <thead style=" font-size: 12px;">
                                <tr>
                                    <th>Sıra</th>
                                    <th>İlan Adı</th>
...
<script>
var table = $('#basvurularim').DataTable({  
        "language": {
            "sDecimal":        ",",
...
var tableKazan = $('#kazandigimBasvuru').DataTable({  
       "language": {
	"sDecimal":        ",",
	"sEmptyTable":     "Tabloda herhangi bir veri mevcut değil",
	"sInfo":           "_TOTAL_ kayıttan _START_ - _END_ arasındaki kayıtlar gösteriliyor",
...
$('#kazandigimBasvuru tbody').on( 'mouseenter', 'td', function () {
    var colIdx = tableKazan.cell(this).index().column;

    $( tableKazan.cells().nodes() ).removeClass( 'highlight' );
    $( tableKazan.column( colIdx ).nodes() ).addClass( 'highlight' );
});
