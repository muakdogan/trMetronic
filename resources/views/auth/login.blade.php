...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Tamrekabet | Kullanıcı Girişi</title>
        ...
        <link href="{{asset('MetronicFiles/global/plugins/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('MetronicFiles/global/plugins/select2/css/select2-bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('MetronicFiles/pages/css/login-3.min.css')}}" rel="stylesheet" type="text/css" />
...
>>>>>>> 39cd80344e68a9810e2c5407d996399422425146
                ...
                <div class="forget-password">
                    ...
                    <p>
                        <a href="javascript:;" id="forget-password"> Buraya </a> tıklayarak şifre oluşturabilirsiniz. </p>
                </div>
                <div class="create-account">
                    <p> Henüz bir hesabınız yok mu ?&nbsp;
                        <a href="javascript:;" id="register-btn"> Hesap Oluştur </a>
                    </p>
                </div>
            </form>
            <!-- END LOGIN FORM -->
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="{{asset('MetronicFiles/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
        <script src="{{asset('MetronicFiles/global/plugins/jquery-validation/js/additional-methods.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{asset('MetronicFiles/pages/scripts/login.min.js')}}" type="text/javascript"></script>
