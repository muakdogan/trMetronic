...
<head>
    ...
    <link href="{{asset('MetronicFiles/pages/css/error.min.css')}}" rel="stylesheet" type="text/css" />
...
<div class="page-inner">
    <img src="{{asset('MetronicFiles/pages/media/pages/earth.jpg')}}" class="img-responsive" alt=""> </div>
<div class="container error-404">
    <h1>404</h1>
    <h2>Bir problemle karşılaşıldı.</h2>
    <p> Aslında Bakarsan böyle bir sayfa yok. </p>
    <p>
        <a href="{{asset('')}}" class="btn red btn-outline"> Anasayfaya Dön </a>
        <br> </p>
</div>
<!--[if lt IE 9]>
